...
La estructura básica de la función ggplot se compone por tres argumentos necesarios: ```data``` en el cuál indicamos el dataframe del cual vamos a seleccionar las variables para graficar;
