...
NEA <- NEA %>% mutate(nivel_ed_recod =
                        case_when(nivel_ed %in% c("Menores de 5 años",
                                                  "Sin instrucción (incluye nunca asistió o sólo asistió a sala de 5)",
                                                  "Primaria/EGB incompleto",
                                                  "Primaria/EGB completo",
                                                  "Secundario/Polimodal incompleto") ~ "Secundaria incompleta o menos",
...
y la percepción del ingreso. Argentina. 2015.",
       y = "IOP ($)",
       caption = "Fuente: elaboración propia en base a PISAC") +
